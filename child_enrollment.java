  ...
  public void actionPerformed(ActionEvent ae){
    ...
    if (s.equals("Update")) {
            try{
              ...
              Connection co=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "db", "5275");
              Connection co1=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "db", "5275");
              Connection co2=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "db", "5275");
